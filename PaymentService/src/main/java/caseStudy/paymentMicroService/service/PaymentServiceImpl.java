...
public class PaymentServiceImpl implements PaymentService {
	...
	public void sendEmail(PaymentDetails payment) throws AddressException {
		final Email email = DefaultEmail.builder().from(new InternetAddress("sudhnitkaur10@gmail.com"))
				.replyTo(new InternetAddress("sudhnitkaur10@gmail.com"))
				.to(Lists.newArrayList(new InternetAddress("sudhnitkaur10@gmail.com")))
				.subject("Payment is Successful")
				.body("Dear Passenger !! "
						+ ""
						+ "Your payment for PNR Number " + payment.getPnrNo() + " is Successful...!!!"
								+ ""
								+ "Shubh Ratri").encoding("UTF-8")
				.build();
